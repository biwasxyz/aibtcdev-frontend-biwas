...
// Reusing the AgentAvatar component logic from ChatMessageBubble
...
export function TypingIndicator({ agentId = null }: TypingIndicatorProps) {
  ...
  return (
    <div className="flex w-full gap-2 px-2 py-1 group min-w-0">
      ...
      <div className="flex flex-col min-w-0 space-y-1 items-start max-w-[85%] sm:max-w-[75%] w-fit">
        <div className="rounded-2xl px-3 py-2 w-fit bg-zinc-800 text-zinc-200">
